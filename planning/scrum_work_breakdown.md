...
| Field | Description |
| ----- | ----------- |
| **ID** | [SCRUM-62](https://codeforge-squad-dosw.atlassian.net/browse/SCRUM-62) |
| **Title** | Record match results |
| **Description** | As the organizer, I want to record the final score of a match to update the tournament information |
| **Priority** | High |
| **Estimate** | 5 points |
...
| Field | Description |
| ----- | ----------- |
| **ID** | [SCRUM-66](https://codeforge-squad-dosw.atlassian.net/browse/SCRUM-66) |
| **Title** | Advance through elimination rounds |
| **Description** | As a system, I want to automatically advance to the next elimination round when the results are recorded |
| **Priority** | High |
| **Estimate** | 5 points |
